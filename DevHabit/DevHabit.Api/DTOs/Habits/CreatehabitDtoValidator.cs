...
public sealed class CreatehabitDtoValidator : AbstractValidator<CreateHabitDto>
{
    ...
    public CreatehabitDtoValidator()
    {
        RuleFor(x => x.Name)
            ...
            .MinimumLength(3)
            .MaximumLength(100)
            .WithMessage("Habit name must be between 3 and 100 characteres");
        ...
        RuleFor(x => x.Target.Value)
            .GreaterThan(0)
            .WithMessage("Target value must be greather than 0");
        ...
        When(x => x.Milestone is not null, () =>
        {
            RuleFor(x => x.Milestone!.Target)
                .GreaterThan(0)
                .WithMessage("Milestone target must be greather than 0");
        });
